...
filter(top_biwords_era, era == "1789–1815: Early Republic") |>
  ggplot(aes(x = biword, y = prop, fill = color)) +
  geom_col(show.legend = FALSE) +
  coord_flip() +
  scale_x_reordered() +
  scale_fill_identity() +
...
filter(top_biwords_era, era == "1816–1865: Expansion, Reform & Civil War") |>
  ggplot(aes(x = biword, y = prop, fill = color)) +
  geom_col(show.legend = FALSE) +
  coord_flip() +
  scale_x_reordered() +
...
filter(top_biwords_era, era == "1866–1919: Reconstruction to WWI") |>
  ggplot(aes(x = biword, y = prop, fill = color)) +
  geom_col(show.legend = FALSE) +
  coord_flip() +
  scale_x_reordered() +
...
filter(top_biwords_era, era == "1920–1945: Interwar & WWII") |>
  ggplot(aes(x = biword, y = prop, fill = color)) +
  geom_col(show.legend = FALSE) +
  coord_flip() +
  scale_x_reordered() +
...
filter(top_biwords_era, era == "1946–1969: Postwar & Civil Rights") |>
  ggplot(aes(x = biword, y = prop, fill = color)) +
  geom_col(show.legend = FALSE) +
  coord_flip() +
  scale_x_reordered() +
...
filter(top_biwords_era, era == "1970–2009: Post-Watergate to Obama") |>
  ggplot(aes(x = biword, y = prop, fill = color)) +
  geom_col(show.legend = FALSE) +
  coord_flip() +
  scale_x_reordered() +
