...
abstract: "This blog focuses on analyzing U.S. presidents' inaugural speeches to determine their complexity in terms of readability. By comparing the readability score with Flesch kincaid formula across different inaugural speeches of presidents that serve between 1789 and 2009, we aim to observe whether inaugural speeches have become easier or harder to understand, and how their emotional tone has changed over time."
...
```{r}
#| label: fig-freq-era
#| fig-cap: "Top Words in Inaugural Speeches by Era"
#| layout-ncol: 2
#| fig-width: 12
#| fig-height: 8
#| out-width: 100%
...
# Add historical eras
inaug_words_freqs_by_pres <- inaug_words_freqs_by_pres |> 
...
# Get top 8 words per era
top_words_era <- inaug_words_freqs_by_pres |> 
  group_by(era, word) |> 
...
ggplot(top_words_era, aes(x = fct_reorder(word, total), y = total, fill = word)) +
  geom_col(show.legend = FALSE) +
  coord_flip() +
...
Figure @fig-freq-era shows the most frequently used words in U.S. presidential inaugural speeches across five historical eras. ...
