...
ggplot(filter(top_biwords_era, era == "1789–1815\nRevolution & Early Republic"),
       aes(x = reorder(biword, prop), y = prop, fill = color)) +
  geom_col(show.legend = FALSE) +
  coord_flip() +
  scale_fill_identity() +
  labs(x = NULL, y = "Proportion of All Bigrams") +
...
ggplot(filter(top_biwords_era, era == "1816–1865\nExpansion, Reform & Civil War"),
       aes(x = reorder(biword, prop), y = prop, fill = color)) +
  geom_col(show.legend = FALSE) +
  coord_flip() +
  scale_fill_identity() +
...
ggplot(filter(top_biwords_era, era == "1866–1919\nReconstruction to WWI"),
       aes(x = reorder(biword, prop), y = prop, fill = color)) +
  geom_col(show.legend = FALSE) +
  coord_flip() +
  scale_fill_identity() +
...
ggplot(filter(top_biwords_era, era == "1920–1945\nInterwar & WWII"),
       aes(x = reorder(biword, prop), y = prop, fill = color)) +
  geom_col(show.legend = FALSE) +
  coord_flip() +
  scale_fill_identity() +
...
ggplot(filter(top_biwords_era, era == "1946–1969\nPostwar & Civil Rights"),
       aes(x = reorder(biword, prop), y = prop, fill = color)) +
  geom_col(show.legend = FALSE) +
  coord_flip() +
  scale_fill_identity() +
...
ggplot(filter(top_biwords_era, era == "1970–2009\nPost-Watergate to Obama"),
       aes(x = reorder(biword, prop), y = prop, fill = color)) +
  geom_col(show.legend = FALSE) +
  coord_flip() +
  scale_fill_identity() +
