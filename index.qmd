...
include_graphics("images/flag.png")

```

*Image source: [Pixabay](https://pixabay.com/vectors/american-flag-usa-flag-symbol-2144392/)*
...
This interactive bar chart displays the average AFINN sentiment score of each U.S. presidential inaugural address from 1789 to 2009 [@AFINN]. The chart was created using ggplot2 with a custom blue–gray–red gradient and made interactive using plotly, allowing readers to hover over each bar for details like president name, year, and sentiment score [@ggplot2gradient; @plotly]. 
...
> Key Insight: While some themes persist, each era’s top bigrams reveal shifting national concerns, from Enlightenment ideals to Cold War tensions and modern appeals to faith.
